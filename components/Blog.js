...
const Blog = () => {
  ...
  //                     Prompt Engineering: How I Use AI to Code Faster & Smarter
  //                   </Link>
  //                 </h5>
  //                 <hr />
  //                 <div className="blog-meta mt-35">
  //                   <a className="date" href="#">
  //                     <i className="far fa-calendar-alt" /> August 19, 2025
  //                   </a>
  //                 </div>
  //               </div>
  //             </div>
  ...
  //                 <h5>
  //                   <Link legacyBehavior href="blog-details">
  //                     Automating HR with Offer Letter Bots using Supabase & Node.js
  //                   </Link>
  //                 </h5>
  //                 <hr />
  //                 <div className="blog-meta mt-35">
  //                   <a className="date" href="#">
  //                     <i className="far fa-calendar-alt" /> September 30, 2025
  //                   </a>
  //                 </div>
  //               </div>
  //             </div>
