          ...
          <div className="col-lg-4">
            <div className="contact-content-part pt-5 rpt-0 rmb-55 wow fadeInUp delay-0-2s">
              <div className="section-title mb-40">
                ...
                <h3>
                  Let’s Discuss Your <span>Data Strategy</span>
                </h3>
                <p>
                  Ready to modernize your data warehouse or build real-time streaming pipelines? Contact me to discuss how we can leverage data to drive business value.
                </p>
              </div>
              <ul className="list-style-two">
                <li>6+ Years in Data Engineering</li>
                <li>AWS | Azure | Databricks | Snowflake</li>
                <li>Batch & Streaming (Spark, Flink, Kafka)</li>
