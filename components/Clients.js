        ...
        <div className="row justify-content-center">
          <div className="col-xl-12">
            <div className="section-title text-center pt-5 mb-65 wow fadeInUp delay-0-2s">
              <h6>
  Delivering Scalable Web Solutions for <span>Startups, Tech Teams & HR Workflows</span>
</h6>
        ...
        {/* <div className="client-logo-wrap">
          <Link legacyBehavior href="contact">
            <a className="client-logo-item wow fadeInUp delay-0-2s" title="Internal HR System Client">
  <img src="assets/images/client-logos/client-logo1.png" alt="HR System Client" />
</a>
