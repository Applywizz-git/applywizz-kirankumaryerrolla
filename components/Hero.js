...
const counterData = [
  { id: 1, text: "Years Of Experience", value: "6", valueType: "plus" },
  { id: 2, text: "Projects Completed", value: "20", valueType: "plus" },
  { id: 3, text: "Success Rate", value: "100", valueType: "percent" },
];
        ...
        <div className="row align-items-center">
          <div className="col-lg-4 col-sm-7">
            <div className="hero-content rmb-55 wow fadeInUp delay-0-2s">
              ...
              <h1>
                <b>KIRAN KUMAR YERROLLA</b><br></br>
              ...
              <div className="hero-btns">
                ...
                <a
                  href="/assets/pdfs/kiran_kumar.pdf"
                  download
                  className="theme-btn"
                >
