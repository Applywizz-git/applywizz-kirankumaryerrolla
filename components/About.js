            ...
            <div className="col-lg-7">
              <div className="about-content-part rel z-2 rmb-55">
                <div className="section-title mb-35 wow fadeInUp delay-0-2s">
                  ...
                  <h2>
                    Scalable <span>Data Engineering</span> & Analytics Solutions
                  </h2>
                  <p>
                    ...
                    <br />
                    Skilled in using PySpark and Databricks to process high-volume datasets, managing Delta Lake layers on AWS S3, and developing batch and streaming ingestion with Glue, Kinesis, Lambda, Kafka, and Flink. Strong background in Airflow orchestration, SQL, Python, and data quality practices.
                  </p>
                </div>
                <ul className="list-style-one two-column wow fadeInUp delay-0-2s">
                  <li>Batch & Streaming Pipelines (Spark, Flink, Kafka)</li>
                  <li>Cloud Data Services (AWS, Azure, Databricks)</li>
                  <li>Data Warehouse Modernization (Snowflake, Redshift)</li>
                  <li>Orchestration & Quality (Airflow, dbt, Great Expectations)</li>
                </ul>
