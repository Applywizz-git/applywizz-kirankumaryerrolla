              ...
              <div className="row justify-content-between">
                ...
                <div className="col-xl-5 col-md-6">
                  <div className="resume-item wow fadeInUp delay-0-4s">
                    ...
                    <div className="content">
                      <span className="years">Sep 2022 - Nov 2023</span>
                      <h4>Data Engineer</h4>
                      <span className="company">CVS Health | Detroit, MI</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-xl-5 col-md-6">
                  <div className="resume-item wow fadeInUp delay-0-2s">
                    ...
                    <div className="content">
                      <span className="years">Jan 2022 - Sep 2022</span>
                      <h4>Software Development Engineer</h4>
                      <span className="company">Amazon | Seattle, WA</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-xl-5 col-md-6">
                  <div className="resume-item wow fadeInUp delay-0-4s">
                    ...
                    <div className="content">
                      <span className="years">Jan 2019 - Dec 2020</span>
                      <h4>Associate Data Engineer</h4>
                      <span className="company">Cholamandalam Investment | Hyderabad, India</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-xl-5 col-md-6">
                  <div className="resume-item wow fadeInUp delay-0-3s">
                    ...
                    <div className="content">
                      <span className="years">Jan 2021 - May 2022</span>
                      <h4>M.S. in Computer Science</h4>
                      <span className="company">Texas A&M University | Kingsville, TX</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-xl-5 col-md-6">
                  <div className="resume-item wow fadeInUp delay-0-4s">
                    ...
                    <div className="content">
                      <span className="years">Aug 2015 - Jun 2019</span>
                      <h4>B.Tech in ECE</h4>
                      <span className="company">JNTU | Hyderabad, India</span>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="col-xl-10">
                  <div className="resume-item wow fadeInUp delay-0-3s">
                    <ul className="list-style-two">
                      ...
                      <li>Power BI Data Analyst Associate - Microsoft</li>
                      <li>IBM Data Engineering Professional Certificate - Coursera</li>
                      <li>Data Modeling & dbt Fundamentals - LinkedIn Learning</li>
                    </ul>
                  </div>
                </div>
              </div>
